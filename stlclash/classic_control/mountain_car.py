...
def make_mountain_car_env(**kwargs: dict) -> gym.Env:
    class Modified_Continuous_MountainCarEnv(gym.Env):
        """
        ## Description
        ...
        *position<sub>t+1</sub> = position<sub>t</sub> + velocity<sub>t+1</sub>*
        ...
        1. Truncation: The length of the episode is 999.
        ...
        * v0: Initial versions release
        ...
        def render(self):
            ...
            coords = []
            for c in [(left, bottom), (left, top), (right, top), (right, bottom)]:
    ...
    return Modified_Continuous_MountainCarEnv(**kwargs)  # type: ignore
